...
//
// Ported to atmega32 by Mostafa El-koumy, Embedded SW Developer
...
static void timer32_init(void)
{
	...
	SOFTUART_COMP_REG = SOFTUART_TIMERTOP;     /* set top */

	SOFTUART_CONTR_REG = SOFTUART_CTC_MASK | SOFTUART_PRESC_MASK;

	SOFTUART_INTCTL_REG |= SOFTUART_CMPINT_EN_MASK;

	SOFTUART_CNT_REG = 0; /* reset counter */
